...
class Benchmark(object):
    ...
    def form_returns(self):
        ...
        return_list = list(zip(date_list,monthly_ret['Log Returns']))

        #Cumulative returns for each date
        cum_ret = monthly_ret['Log Returns'].cumsum()
        cumulative_return_list = list(zip(date_list, cum_ret))
                
        return {"benchmark_monthly_returns": return_list,
                "benchmark_cumulative_returns": cumulative_return_list
                }
